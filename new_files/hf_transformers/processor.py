...
def get_processor(
    ...
    **kwargs,
    ...
    try:
        ...
        logger.warning("AutoProcessor build failed (%s); falling back to AutoTokenizer", e)
        from transformers import AutoTokenizer as _AT
        for _k in ("size", "_from_auto"):
            kwargs.pop(_k, None)
        processor = _AT.from_pretrained(tokenizer_name, *args, trust_remote_code=trust_remote_code, revision=revision, **kwargs)
    if (
